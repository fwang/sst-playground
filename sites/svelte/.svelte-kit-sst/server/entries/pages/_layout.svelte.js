...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="svelte-1u9z1tp"><div class="corner svelte-1u9z1tp"><a href="https://kit.svelte.dev" class="svelte-1u9z1tp"><img${add_attribute("src", logo, 0)} alt="SvelteKit" class="svelte-1u9z1tp"></a></div>
    ...
    0
  )} class="svelte-1u9z1tp"><a href="/sverdle" class="svelte-1u9z1tp">Sverdle</a></li>
			<li${add_attribute("aria-current", $page.url.pathname === "/tests" ? "page" : void 0, 0)} class="svelte-1u9z1tp"><a href="/tests" class="svelte-1u9z1tp">Tests</a></li></ul>
